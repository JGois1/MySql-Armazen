...
select nomecliente, cidade, estado civil from cliente;
select * from cliente;
...
select nomecliente, estado, cidade from cliente order by estado, cidade;

-- ex09, ex10 (imprimir dados sem repetição)
select distinct estado from cliente order by estado asc;
select distinct dtcompra from compras order by dtcompra desc;

-- ex11 -> ex16:
select nomeproduto, preco from produto where preco > 5.00;
...
select nomecliente, dtnascimento from cliente where dtnascimento < '2004-05-13';
select distinct idcliente from compras where dtcompra between '2021-01-01' and '2021-12-31';
select distinct idcliente, extract(year from dtcompra) from compras where extract(year from dtcompra) = '2020';
-- ex17 -> ex19:
select nomecliente from cliente where nomecliente like 'A%';
select nomecliente from cliente where nomecliente like '%Ana%';
select nomecliente, estadocivil from cliente where estado in ('Rio de Janeiro','São Paulo','Espírito Santo','Minas Gerais');
